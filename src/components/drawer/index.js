            ...
            <List>
                <ListItem disablePadding sx={{ display: 'block' }}>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => NavigateTo("/products2")} sx={{ height: 50 }}>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/products1/list")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="List">
                                    <AddLink color="primary" />
                                </Tooltip>
                        ...
                        <ListItemButton onClick={() => NavigateTo("/products3/tiles")} sx={{ height: 50 }}>
                            <ListItemIcon sx={{ minWidth: 30 }}>
                                <Tooltip title="Tiles">
                                    <AddLink color="primary" />
                                </Tooltip>
